...
> Design notes for **nonprofit-job-log-search** — a runnable python example that Ship typed nonprofit job events as structured logs and search their outcomes.
...
- **Feature code** — the actual task: nonprofit-job-logs.
